...
while True:
    ...
    if lmList:
        ...
        sholder_r_angle, img = detector.findAngle(lmList[11][0:2],
                                        lmList[12][0:2],
                                        lmList[14][0:2],
                                        img=img,
                                        color=(0, 255, 0),
        ...
        elbow_r_angle, img = detector.findAngle(lmList[12][0:2],
                                        lmList[14][0:2],
                                        lmList[16][0:2],
                                        img=img,
                                        color=(0, 255, 0),
        ...
        wrist_r_andgle, img = detector.findAngle(lmList[14][0:2],
                                        lmList[16][0:2],
                                        lmList[20][0:2],
                                        img=img,
                                        color=(0, 255, 0),
